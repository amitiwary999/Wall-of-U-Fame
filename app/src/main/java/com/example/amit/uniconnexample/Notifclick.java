                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if (processlike) {
                                if (dataSnapshot.child(key).hasChild(user.getUid())) {
                                    ...
                                    mDatabase.setValue(new Blogmodel(model.getKey(), model.getDesc(), model.getImage(), model.getName(), model.getPropic(), lik, model.getUnlike(), model.getTime(), model.getDate()));
                                    ...
                                    mDatabaseunlike.addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                            ...
                                            if (dataSnapshot.child(key).hasChild(user.getUid())) {
                                                ...
                                                mDatabase.setValue(new Blogmodel(model.getKey(), model.getDesc(), model.getImage(), model.getName(), model.getPropic(), lik, unlik, model.getTime(), model.getDate()));
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if(processunlike){
                                if(dataSnapshot.child(key).hasChild(user.getUid())){
                                    ...
                                    mDatabaseunlike.child(key).child(user.getUid()).removeValue();
                                    mDatabase.setValue(new Blogmodel(model.getKey(),model.getDesc(),model.getImage(),model.getName(),model.getPropic(),model.getLike(),unlike,model.getTime(),model.getDate()));
                                    ...
                                    mDatabaseLike.addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                            ...
                                            if(dataSnapshot.child(key).hasChild(user.getUid())){
                                                ...
                                                mDatabaseLike.child(key).child(user.getUid()).removeValue();
                                                mDatabase.setValue(new Blogmodel(model.getKey(),model.getDesc(),model.getImage(),model.getName(),model.getPropic(),lyk,unlike,model.getTime(),model.getDate()));
